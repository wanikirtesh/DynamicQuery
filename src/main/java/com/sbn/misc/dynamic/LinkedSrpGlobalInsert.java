...
public class LinkedSrpGlobalInsert {
    public static void main(String[] args) throws Exception {
        Object[][] data = {{"SEAHM",20221,20240,"PCRS"}};
        //globalSRP();
        for (Object[] datum : data) {
            derivationSRP(datum[0].toString(),(int)datum[1],(int)datum[2],datum[3].toString());
            activeSRP(datum[0].toString(),(int)datum[1],(int)datum[2],datum[3].toString());
        }

    }

    private static void derivationSRP(String prodPropertyCode, int startProperty, int endProperty, String integration) throws Exception {
    ...
    private static void activeSRP(String prodPropertyCode, int startProperty, int endProperty, String integration) throws Exception {
        ConnectionManager cm = new ConnectionManager("mn4sg3xdbsw101.ideasstg.int", "master", "sa", "IDeaS123");
        List<String> lines = Files.readAllLines(Paths.get("C:\\Users\\idnkiw\\OneDrive - SAS\\Desktop\\HCRS_SRP_Derivation_20210427.psv"));
